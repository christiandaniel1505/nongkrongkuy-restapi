...
class HalamanAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.index', compact('daftar'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('home.index')->with('success', 'daftar cafe Berhasil ditambahkan');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.index', compact('daftar', 'prev', 'next'));
    }
    ...
    public function destroy($id)
    {
        ...
        //jika berhasil, kembalike halaman utama
        return redirect()->route('home.index')->with('success', 'home berhasil dihapus');
    }
}
